...
static const std::unordered_map<char, OpInfo> OPS = {
  ...
  { 'c', { Arity::UNARY,    [](double a, double){ return cos(DEG_TO_RAD * a); } } },
  { 's', { Arity::UNARY,    [](double a, double){ return sin(DEG_TO_RAD * a); } } },
  { 't', { Arity::UNARY,    [](double a, double){ return tan(DEG_TO_RAD * a); } } },  // ← bug corretto
  { 'y', { Arity::UNARY,    [](double a, double){ return RAD_TO_DEG * asin(a); } } },
  { 'u', { Arity::UNARY,    [](double a, double){ return RAD_TO_DEG * acos(a); } } },
  { 'i', { Arity::UNARY,    [](double a, double){ return RAD_TO_DEG * atan(a); } } },
